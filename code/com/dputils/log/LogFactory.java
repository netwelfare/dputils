...
public abstract class LogFactory
{
	 ...
	 */
	public static final String FACTORY_PROPERTY = "com.dputils.log.LogFactory";

	/**
	 * The fully qualified class name of the fallback <code>LogFactory</code>
	 * implementation class to use, if no other can be found.
	 */
	public static final String FACTORY_DEFAULT = "com.dputils.log.impl.LogFactoryImpl";
	...
	private static final String WEAK_HASHTABLE_CLASSNAME = "com.dputils.log.impl.WeakHashtable";
	...
	public static Log getLog(Class clazz) throws LogConfigurationException
	{
		...
		Log log = factory.getInstance(clazz);
		return log;
	}
		...
		if (logFactoryClass != null)
		{
			try
			{
				...
				else
				{
					...
					Class factoryFromCustomLoader = Class.forName("org.apache.commons.logging.LogFactory", false,
