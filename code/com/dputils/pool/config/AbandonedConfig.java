...
package com.dputils.pool.config;

import java.io.PrintWriter;

import com.dputils.pool.GenericObjectPool;
import com.dputils.pool.tracke.TrackedUse;
import com.dputils.pool.tracke.UsageTracking;
...
public class AbandonedConfig
{
	 ...
	 *
	 * <p>
	 * If set to true, abandoned objects are removed by borrowObject if there
	 * are fewer than 2 idle objects available in the pool and
	 ...
	 *            true means abandoned objects will be removed by borrowObject
	 ...
	 *
	 * <p>
	 * If set to true, abandoned objects are removed by the pool maintenance
	 * thread when it runs. This setting has no effect unless maintenance is
	 * enabled by setting
	 * {@link GenericObjectPool#getTimeBetweenEvictionRunsMillis()
	 * timeBetweenEvictionRunsMillis} to a positive number.
	 * </p>
	 *
	 ...
	 *            true means abandoned objects will be removed by pool
	 *            maintenance
	...
	/**
	 * Determines whether or not to log stack traces for application code which
	 * abandoned an object.
	 */
	 ...
	 *
	 * Defaults to false. Logging of abandoned objects adds overhead for every
	 * object created because a stack trace has to be generated.
	 *
	...
	/**
	 * Sets the flag to log stack traces for application code which abandoned an
	 * object.
	 *
	 * @param logAbandoned
	...
	/**
	 * PrintWriter to use to log information on abandoned objects. Use of
	 * default system encoding is deliberate.
	 */
	...
	/**
	 * Sets the log writer to be used by this configuration to log information
