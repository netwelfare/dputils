...
public abstract class BaseGenericObjectPool<T>
{
	 ...
	 * by this pool. The Pool will attempt to load the class using the thread
	 * context class loader. If that fails, the Pool will attempt to load the
	 * class using the class loader that loaded this class.
	 *
