...
public class PooledSoftReference<T> extends DefaultPooledObject<T>
{
	 ...
	 *
	 * <p>
	 * This method exists to allow a new, non-registered reference to be held by
	 * the pool to track objects that have been checked out of the pool. The
	 * actual parameter <strong>should</strong> be a reference to the same
